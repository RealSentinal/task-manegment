    ...
    return (
        <Card className="bg-zinc-800 border-none shadow-2xl">
            ...
            <CardContent className="flex flex-col">
                ...
                <Input className="mb-1 bg-zinc-700 border-none placeholder:text-zinc-400 mt-1" type="email" placeholder="Email" />
                <div className="flex flex-row gap-2 mt-1 mb-1">
                    <Input className="bg-zinc-700 border-none placeholder:text-zinc-400" type="password" placeholder="Password" />
                    <Input className="bg-zinc-700 border-none placeholder:text-zinc-400" type="password" placeholder="Confirm Password" />
                </div>
